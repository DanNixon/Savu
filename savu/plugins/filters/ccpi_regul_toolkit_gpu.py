...
@register_plugin
class CcpiRegulToolkitGpu(Plugin, GpuPlugin):
    """
    ...
    def __init__(self):
        super(CcpiRegulToolkitGpu, self).__init__('CcpiRegulToolkitGpu')
        self.GPU_index = None
        self.res = False
        self.start = 0
    ...
    def pre_process(self):
        ...
        if self.parameters['method'] == 'ROF_TV':
            ...
            self.pars = {
                'algorithm': self.parameters['method'],
